...
for ($i = 1; $i <= $maxLoops; $i++) {
   // generate random hex seq
   // https://stackoverflow.com/questions/13440206/generator-for-random-long-hex-strings-in-php
   $strMatrixCode["hex"] = strtoupper(bin2hex(openssl_random_pseudo_bytes(24)));
   $strMatrixCode["hex"] = str_pad($strMatrixCode["hex"], 84, 0, STR_PAD_RIGHT);
   $strMatrixCode["bin"] = iconv("ISO-8859-1", 'UTF-8', hex2bin($strMatrixCode["hex"]));
